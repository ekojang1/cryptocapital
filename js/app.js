...
function submitInvestment() {
  ...
  var selectedCrypto = document.getElementById("cryptoType").value;
  ...
  // Process the investment (you can add your logic here)

  // For demonstration purposes, let's log the details
  console.log("Investment Details:");
  console.log("Amount to Invest: $" + investmentAmount);
...
document.getElementById('logoutLink').addEventListener('click', function(event) {
  event.preventDefault(); // Prevent the default link behavior (prevents navigation)

  // Add code to redirect to the original web page
  window.location.href = "Desktop/TEMPLATES/CryptoCapital/index.html"; // Replace "index.html" with your actual path
});
