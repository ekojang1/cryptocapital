            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <p>Welcome to CryptoCapital, a leading authority in the world of cryptocurrencies and blockchain technology. Our journey began with a vision to demystify the complexities of this rapidly evolving financial landscape and provide individuals with the knowledge and resources to navigate it with confidence.
                        </p>
                        <p class="mb-4">At CryptoCapital, our mission is to empower individuals, investors, and enthusiasts by offering in-depth insights, educational resources, and expert analysis on the ever-expanding universe of cryptocurrencies. We are committed to promoting financial literacy, fostering responsible investment practices, and fostering a greater understanding of the transformative potential of blockchain technology.</p>
                        <div class="d-flex align-items-center mb-2">
                            <i class="fa fa-check bg-light text-primary btn-sm-square rounded-circle me-3 fw-bold"></i>
                            <span>Team of experienced professionals.</span>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="fa fa-check bg-light text-primary btn-sm-square rounded-circle me-3 fw-bold"></i>
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <i class="fa fa-check bg-light text-primary btn-sm-square rounded-circle me-3 fw-bold"></i>
                            <span>Multi-asset support like BTC, ETH, DOGECOIN and LTC</span>
                        </div>
                    <div class="d-flex align-items-center mb-2">
                                <i class="fa fa-check bg-light text-primary btn-sm-square rounded-circle me-3 fw-bold"></i>
                                <span>No monthly/annual fees and no FX fees</span>
                            </div>
                    </div>
                </div>
            </div>
